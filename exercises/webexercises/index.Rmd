...
### Complete as sentenças conforme os enunciados:
...
`r fitb("^[a-z-_]+$", width = 20, ignore_ws = FALSE, regex = TRUE)`  `r fitb("<-", width = 2, regex = TRUE)`  `r fitb("^[\"][a-zA-ZÀ-ú0-9\r!@#$%^&*()_+-=?',;.:/}{~´]+\"$", width = 50, regex = TRUE)`
...
opts_p <- c(
   ...
   'Vai gerar um erro. É preciso colocar o comando entre aspas duplas (" 1 + \'1\' ") para a operação de soma seja possível.',
...
opts_p <- c(
    ...
    answer = "Imprime um erro pois o parênteses precisa ser fechado. Os parênteses representam uma função primitiva do R cujo uso semântico correto é ( ... ).",
