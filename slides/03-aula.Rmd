...
> https://tsklipp.github.io/metodologias-informacionais-com-r/dados/taxa_desocupacao_sexo_2012-2013.csv
...
- <p class="jst">Leia o arquivo .purple[.xlsx] salvo usando a função .purple[`readxl::read_excel()`] e armazene os dados em um objeto. Qual o tipo desse novo objeto? </p>

- <p class="jst">Considerando a estruturação atual dos dados, é possível executar diferentes operações sobre os mesmos e tarefas de análise com facilidade?</p>

---
class: center, middle

```{r message=FALSE, warning=FALSE, echo=FALSE}
dt <- readxl::read_excel("../dados/taxa_desocupacao_idade_2012-2013.xlsx")
library(kableExtra)
dt %>%
...
```{r message=FALSE, warning=FALSE, echo=FALSE}
dt <- readr::read_delim("../dados/taxa_desocupacao_sexo_2012-2013.csv", delim = ";",skip = 1)
library(kableExtra)
dt %>%
    kable(caption = 'Taxa de Desocupação') %>%
    kable_styling(bootstrap_options = c('striped', 'condensed')) %>%
