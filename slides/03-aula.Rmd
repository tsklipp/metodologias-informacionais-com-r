...
<p class="jst">Na menu principal do RStudio: File `->` New Project `->` New Directory `->` New Project. </p>
...
> .center.large[<b>Certo! E agora?</b> ] 
...
<p class="jst"> O RStudio tem várias funcionalidades interessantes. Por exemplo, é possível rodar os exemplos do uso de uma função, disponíveis na aba Ajuda. No entanto, essa funcionalidade requer o pacote .purple[`knitr`]. </p>

<p class="jst">Faça uma consulta usando <i>help</i> ao pacote .purple[`datasets`], na forma:</p>
  ```{r, eval=FALSE}
  help(package = "datasets")
  ```

<p class="jst"> Procure e clique no conjunto de dados .purple[`sunspots`]  e rode o exemplo apresentado clicando no <i>link .blue[Run examples]</i>. </p>

--

<p class="jst">Muito provavelmente você não terá o pacote  .purple[`knitr`] instalado. Portanto, instale esse pacote e depois tente rodar o exemplo novamente.</p>
...
.center.large[<b>Bom! Agora, enfim, começa a parte divertida!</b>]
...
- <p class="jst"> Crie uma pasta de dados no seu .purple[R project] e faça o <i>download</i> de dois arquivos contendo séries  históricas de desocupação (Fonte: PNAD contínua), conforme:</p> 
  ...
  download.file(url = "link 2", destfile = "dados/file-name.xlsx")
  ```
...
---
### .orange[Fundamentos do R - `r icons::fontawesome("database")` tidy data]
