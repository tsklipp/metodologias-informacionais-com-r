...
---
### .orange[`r icons::ionicons("bar-chart-outline")` Visualização de `r icons::fontawesome("table")` dados - plotly]

<p class="jst">O pacote <A href="https://plotly.com/r/">.purple[<b>plotly</b>]</b></A> permite a criação de gráficos interativos diversos. Essa bibliteca é fornecida pela empresa Plotly (sede em Quebec, Canadá) que produz serviços para análise e visualização de dados em páginas <i>web</i>. Também são fornecidas bibliotecas para outras linguagens de programação como MATLAB, python, entre outras. O pacote  .purple[<b>plotly</b>] tem como principais características:</p>

- Tem licença aberta, ou seja, pode ser usada livremente.
- Renderiza os gráficos através da biblioteca <i>JavaScript</i> .purple[plotly.js].
- Baseado na fisosofia <i>"Grammar of Graphics"</i>.
- Permite converter gráficos estáticos gerados pelo .purple[<b>ggplot2</b>] em interativos.

---
### .orange[`r icons::ionicons("bar-chart-outline")` Visualização de `r icons::fontawesome("table")` dados - plotly - ggplotly]

<b>Como criar um gráfico interativo?</b>

<p class="jst">Um modo prático para obter um gráfico interativo é converter um gráfico gerado a partir do pacote .purple[<b>ggplot2</b>] usando a função de conversão .purple[ggplotly()] do pacote .purple[<b>plotly</b>]. Primeiro, precisamos desse pacote instalado e carregado:</p>
  ```{r, message=FALSE}
...
<p class="jst">Também podemos criar o gráfico diretamente, conforme:</p>

```{r p20, message=FALSE, eval=FALSE}
...
.pull-right[
```{r p20_out, ref.label="p20", echo=FALSE, warning=FALSE, message=FALSE}
```
]
...
- No próprio <A href="https://plotly.com/r/">.purple[site]</b></A> do pacote.

- Materiais <A href="https://site.statplace.com.br/blog/como-usar-o-pacote-plotly-no-r/">.purple[online]</b></A>. 
