...
<p class="jst"> <b>Observação</b>: Em uma projeção, queremos mapear o globo terrestre para uma superfície plana, o que envolve tranformações de coordenadas (latitudes e longitudes) da superfície esférica para a plana. Existem diversas formas de projeções possíveis (ex: cilíndrica, cônica, plana, Robinson e Mollweide).</p>
...
1. Obter um conjunto de dados de um mapa base.

2. Adicionar/mapear os dados e metadados que nos interessam ao mapa base.
...
<p class="jst"> Podemos gerar esse mapa simples, conforme o código abaixo. A variável <b>group</b> possui os códigos individuais dos países, que indicamos no atributo estético, de mesmo nome, para unir os vértices dos polígonos (coordenadas das colunas <b>long</b> e <b>lat</b>), ou seja, para gerar os contornos territoriais de cada país. Fixamos o preenchimento dos polígonos na cor cinza e as fronteiras como linhas pretas.</p>
...
<p class="jst"> <b>Número total e proporção da população por sexo e unidade da federação?</b> Podemos agregar somente por estado, para estimar com a função .purple[count()] a distribuição da população segundo o sexo, considerando pesos (<b>wt = V1028</b>). Os valores serão armazenados na variável <b>n</b>, e a proporção pode ser obtida ao dividir o total por sexo (<b>n</b>) em cada estado pela soma desses totais (homens + mulheres = <b>sum(n)</b>), sendo que o agrupamento permite isso:</p>
...
```{r p4b, message=FALSE, eval=FALSE}
  ...
  p1 / p2 + plot_annotation(title = "Distribuição da população.", caption = my_cap)
```
...
Documentação para uso do pacote <A href="https://guilhermejacob.github.io/context/index.html">.purple[<b>convey</b></b>]</A>.</br>
Documentação para uso do pacote <A href="https://cran.r-project.org/web/packages/geobr/vignettes/intro_to_geobr.html">.purple[<b>geobr</b>]</A>.</br>
Documentação para uso do pacote <A href="https://cran.r-project.org/web/packages/censobr/vignettes/censobr.html">.purple[<b>censobr</b>]</A>.</br>
Documentação para uso do pacote <A href="http://electionsbr.com/articles/introduction.html">.purple[<b>electionsBR</b>]</A>.</br>
Documentação para uso do pacote <A href="https://github.com/rfsaldanha/microdatasus/wiki">.purple[<b>microdatasus</b>]</A>.


Livro sobre o pacote <A href="https://r-tmap.github.io/tmap-book/
">.purple[<b>tmap</b>]</A>.</br>
