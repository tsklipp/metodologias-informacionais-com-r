...
background-image: url(figuras/template_middlepage.png)
...
knitr::include_graphics("figuras/basicblibliograph.png") 
```
]
]
...
background-image: url(figuras/r_atterminal.png)
...
background-image: url(figuras/rstudio_panels.png)
background-size: contain
...
---
background-image: url(figuras/rcommunity.png)
background-size: cover
...
background-image: url(figuras/rstudio_panels_console.png)
background-size: contain
background-position: 
...
background-image: url(figuras/rstudio_panels_ajuda.png)
background-size: contain
...
background-image: url(figuras/rstudio_panels_arquivos.png)
background-size: contain
...
knitr::include_graphics("figuras/newfile.png")
```
...
```{r out.width = '100%', echo=FALSE, fig.align = "center"}
knitr::include_graphics("figuras/openfile.png")
```
...
knitr::include_graphics("figuras/script_example1.png")
```
...
```{r out.width = '95%', echo=FALSE, fig.align = "right"}
knitr::include_graphics("figuras/script_example2.png")
```
...
background-image: url(figuras/rstudio_panels_ambiente.png)
background-size: contain
...
background-image: url(figuras/template_endpage.png)
background-size: contain
